...
class _ProfilePageState extends ConsumerState<ProfilePage> {
  ...
  Future<void> _refreshData({bool showAppBarIndicator = true}) async {
    ...
    try {
      ...
      final linuxDoEcosystem = AppConstants.site.supportsLinuxDoEcosystem;
      final ldcEnabled =
          linuxDoEcosystem && (prefs.getBool('ldc_enabled') ?? false);
      final cdkEnabled =
          linuxDoEcosystem && (prefs.getBool('cdk_enabled') ?? false);
      await Future.wait([
  ...
  Widget _buildCommunityCard(
    ...
    return SegmentedCardGroup(
      children: [
        ...
        if (AppConstants.site.supportsConnectStats)
          _buildOptionTile(
    ...
    if (isLoggedIn) {
      ...
      return Padding(
        ...
        child: FilledButton.icon(
          ...
          label: Text(
            context.l10n.profile_loginCommunity(
              AppConstants.site.displayName,
            ),
